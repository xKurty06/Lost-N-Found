...
const foundItems = [
	...
	},
	{
		id: 5,
		title: "Bag",
		date: "Last week, 4:45pm",
		location: "Main Building",
		note: "Left in the classroom",
		color: "Red",
		image: "/images/logo.png",
	},
	{
		...
		note: "Found near the entrance gate",
		color: "Silver",
		image: "/images/login-bg.png",
	},
	{
	...
	},
	{
		id: 8,
		title: "Sunglasses",
		date: "Last week, 1:15pm",
		location: "Cafeteria",
		note: "Found on the counter",
		color: "Black",
		image: "/images/cvsu-homebg.jpg",
	},
];
...
export default function FoundItemPage() {
	...
	function sortItems(items: typeof foundItems, sort: string) {
		switch (sort) {
			case "oldest":
